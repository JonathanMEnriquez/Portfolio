                ...
                <footer>
                    <div className="top">
                        <motion.div whileHover={{ scale: 1.1 }}>
                            <a href={google.resumeLink} target="_blank">
                                {resume.download}
                            </a>
                        </motion.div>
                    </div>
                    <div className="options">
                        <div>
                            <motion.div whileHover={{ scale: 1.2 }}>
                                <a href="https://www.linkedin.com/in/jonathan-enriquez/" target="_blank">
                        ...
                        <div>
                            <motion.div whileHover={{ scale: 1.2 }}>
                                <a href="https://github.com/JonathanMEnriquez/" target="_blank">
